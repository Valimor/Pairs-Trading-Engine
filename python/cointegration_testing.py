...
data = download_ticker_data_vix(universe, '2010-01-01', '2019-01-01')
...
for p in results:
    ...
    if write_to_csv:
        ...
        # export the data
        combined_df.to_csv(f'data/historical/{p[0]}_{p[1]}_market_data.csv')

if write_to_csv:
    print(f"Data exported to data/historical/")